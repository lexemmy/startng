           ...
           $userExists = find_user($email);
             if($userExists){
                    ...
                    $userObject->password = password_hash($password, PASSWORD_DEFAULT);
                        ...
                        $message = "Your account on start.ng has just been updated, your password has changed. if you did not initiate the password change, please visit start.ng and reset your password immediatly";

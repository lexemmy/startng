...
?>
        ...
        <p>
                <a href="paybill.php" class="btn btn-bg btn-primary"> Pay Bill</a>
            </p>
            <p>
                <a href="bookappointment.php" class="btn btn-bg btn-primary"> Book appointment</a>
            </p>
			<p>
                <a href="txhistory.php" class="btn btn-bg btn-primary"> View transactions history </a>
            </p>
		</div>
